...
def calculate_score(cards):
    """Takes list of cards and returns the sum of scores"""
...
def play_game():
    ...
    while not is_game_over:
        ...
        print(f" The user cards {user_cards}")
        print(f" The computer first card is: {computer_cards[0]}")

        if user_score ==0 or computer_score == 0 or user_score > 21:
            is_game_over = True
        else:
            user_should_deal = input("Do you want to get another card? Type 'y or 'n").lower()
